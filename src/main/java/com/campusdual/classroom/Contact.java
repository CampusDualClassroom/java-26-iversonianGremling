...
public class Contact {
    ...
    private String generateContactCode() {
        // Pillar la primera letra del nombre en minuscula
        // Si el apellido no es el ultimo o no es "del" o "de" pillar la primera letra
        // Meter el ultimo apellido integro
